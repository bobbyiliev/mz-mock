...
var terminal_user_title = "materialize";
...
function submit_command() {
    ...
    if (registry.has(command.toUpperCase())) {
        registry.get(command.toUpperCase())(command);
    } else {
        block_log("'" + command.toUpperCase() + "' is not a registered command, please refer to documentation for proper usage.");
    }
}
